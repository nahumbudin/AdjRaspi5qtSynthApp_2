 ...
 *	@version	2.0
 *
 *	@brief		Analog Synthesizer instrument Morphed PAD Synthesizer (iFFT) GUI handling
 *
 *	History:
...
int Dialog_AnalogSynth_1900x1000::init_pad_gui()
{
	int result;
	...
	// PAD Send and Tune frame and controls
	result = init_frame_colors(ui->frame_PAD_SendFiltersTuneOffset);

	result = init_dial_control_colors(ui->dial_PadSendFilter1);
	result = init_dial_control_colors(ui->dial_PadSendFilter2);

	result = init_combobox_control_colors(ui->comboBox_PadTuneOctave);
	result = init_combobox_control_colors(ui->comboBox_PadTuneSemitones);
	result = init_combobox_control_colors(ui->comboBox_PadTuneCents);
	...
	// Frequency Modulation frame and controls
	result = init_frame_colors(ui->frame_PAD_FreqMod);

	result = init_dial_control_colors(ui->dial_PadFreqModLFOLevel);
	result = init_dial_control_colors(ui->dial_PadFreqModAdsrLevel);

	result = init_combobox_control_colors(ui->comboBox_PadFreqModLFO);
	...
	result = init_frame_colors(ui->frame_PAD_AmpMod);

	result = init_dial_control_colors(ui->dial_PadAmpModLFOLevel);
	result = init_dial_control_colors(ui->dial_PadAmpModAdsrLevel);

	result = init_combobox_control_colors(ui->comboBox_PadAmpModLFO);
	...
	result = init_frame_colors(ui->frame_PAD_Profile);
	...
	// PAD Harmonys 1-6 Frame and controls
	result = init_frame_colors(ui->frame_PAD_Haromonys1_6);

	result = init_vertical_slider_control_colors(ui->verticalSlider_PadHarmony_1);
	result = init_vertical_slider_control_colors(ui->verticalSlider_PadHarmony_2);
	result = init_vertical_slider_control_colors(ui->verticalSlider_PadHarmony_3);
	result = init_vertical_slider_control_colors(ui->verticalSlider_PadHarmony_4);
	result = init_vertical_slider_control_colors(ui->verticalSlider_PadHarmony_5);
	result = init_vertical_slider_control_colors(ui->verticalSlider_PadHarmony_6);

	// PAD Harmonys 7-10 Frame and controls
	result = init_frame_colors(ui->frame_PAD_Haromonys7_10);

	result = init_vertical_slider_control_colors(ui->verticalSlider_PadHarmony_7);
	result = init_vertical_slider_control_colors(ui->verticalSlider_PadHarmony_8);
...
void Dialog_AnalogSynth_1900x1000::set_pad_signals_connections()
{
...
void Dialog_AnalogSynth_1900x1000::pad_update()
{
	...
	if (pad_enabled)
	{
		...
		ui->frame_PAD_Haromonys7_10->setEnabled(true);
	...
	else
	{
		...
		ui->frame_PAD_Haromonys7_10->setEnabled(false);
...
void Dialog_AnalogSynth_1900x1000::pad_setup_spectrum_plot(QCustomPlot *spectrumPlot)
{
	const int width = 12;
	float sum;
...
void Dialog_AnalogSynth_1900x1000::pad_setup_profile_plot(QCustomPlot *profilePlot)
{
...
void Dialog_AnalogSynth_1900x1000::pad_replot_profile()
{
...
void Dialog_AnalogSynth_1900x1000::pad_replot_spectrum()
{
	pad_setup_spectrum_plot(ui->widget_PadPlotSpectrum);
	ui->widget_PadPlotSpectrum->replot();
}

void Dialog_AnalogSynth_1900x1000::on_pad_enable_checkbox_changed(bool val)
{
	ui->checkBox_PadActive->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_detune_octave_combobox_changed(int val)
{
	ui->comboBox_PadTuneOctave->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_detune_semitones_combobox_changed(int val)
{
	ui->comboBox_PadTuneSemitones->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_detune_cents_combobox_changed(int val)
{
	ui->comboBox_PadTuneCents->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_send_filter1_dial_changed(int val)
{
	ui->dial_PadSendFilter1->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_send_filter2_dial_changed(int val)
{
	ui->dial_PadSendFilter2->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_freq_mod_lfo_combobox_changed(int val)
{
	ui->comboBox_PadFreqModLFO->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_freq_mod_lfo_level_dial_changed(int val)
{
	ui->dial_PadFreqModLFOLevel->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_freq_mod_env_combobox_changed(int val)
{
	ui->comboBox_PadFreqModAdsr->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_freq_mod_env_level_dial_changed(int val)
{
	ui->dial_PadFreqModAdsrLevel->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_amp_mod_lfo_combobox_changed(int val)
{
	ui->comboBox_PadAmpModLFO->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_amp_mod_lfo_level_dial_changed(int val)
{
	ui->dial_PadAmpModLFOLevel->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_amp_mod_env_combobox_changed(int val)
{
	ui->comboBox_PadAmpModAdsr->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_amp_mod_env_level_dial_changed(int val)
{
	ui->dial_PadAmpModAdsrLevel->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_quality_combobox_changed(int val)
{
	ui->comboBox_PadQuality->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_base_note_combobox_changed(int val)
{
	ui->comboBox_PadBaseNote->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_base_width_slider_changed(int val)
{
	ui->horizontalSlider_PadBaseWidth->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_shape_combobox_changed(int val)
{
	ui->comboBox_PadShape->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_shape_cutoff_combobox_changed(int val)
{
	ui->comboBox_PadShapeCutoff->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_generate_pushbutton_clicked()
{
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmony1_level_slider_changed(int val)
{
	ui->verticalSlider_PadHarmony_1->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmony2_level_slider_changed(int val)
{
	ui->verticalSlider_PadHarmony_2->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmony3_level_slider_changed(int val)
{
	ui->verticalSlider_PadHarmony_3->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmony4_level_slider_changed(int val)
{
	ui->verticalSlider_PadHarmony_4->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmony5_level_slider_changed(int val)
{
	ui->verticalSlider_PadHarmony_5->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmony6_level_slider_changed(int val)
{
	ui->verticalSlider_PadHarmony_6->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmony7_level_slider_changed(int val)
{
	ui->verticalSlider_PadHarmony_7->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmony8_level_slider_changed(int val)
{
	ui->verticalSlider_PadHarmony_8->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmony9_level_slider_changed(int val)
{
	ui->verticalSlider_PadHarmony_9->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmony10_level_slider_changed(int val)
{
	ui->verticalSlider_PadHarmony_10->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_pad_harmonies_detune_slider_changed(int val)
{
	ui->verticalSlider_PadHarmonyDetune->blockSignals(true);
