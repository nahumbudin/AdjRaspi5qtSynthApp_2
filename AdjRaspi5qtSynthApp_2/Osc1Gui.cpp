...
void osc1_unison_mode_selected_func_wrapper(int mod)
{
	Dialog_AnalogSynth_1900x1000::get_instance()->osc1_set_unison_mode(mod);
}
                                          
int Dialog_AnalogSynth_1900x1000::init_osc1_gui()
{
	int result;
	...
	ui->comboBox_Osc1TuneOctave->setFrameWidth(2);
	

	// OSC1 Frequency Modulation frame and controls
	...
	mod_synth_register_set_osc_1_unison_mode_callback(
		&osc1_unison_mode_selected_func_wrapper);
...
void Dialog_AnalogSynth_1900x1000::osc1_set_unison_mode(int mode)
{
	int i;
...
void Dialog_AnalogSynth_1900x1000::osc1_set_unison_labales(QList<QString> str, uint16_t mask)
{
	int i = 0;
...
void Dialog_AnalogSynth_1900x1000::osc1_set_unison_labales(int mode)
{
	switch (mode)
	{
...
void Dialog_AnalogSynth_1900x1000::osc1_en_dis_sliders(uint16_t mask)
{
	if (mask & 0x01)
	{
...
void Dialog_AnalogSynth_1900x1000::osc1_update()
{
	...
	if (osc1_enabled)
	{
		...
		ui->frame_Osc1FrequencyModulation->setEnabled(true);
	...
	else
	{
		...
		ui->frame_Osc1FrequencyModulation->setEnabled(false);
...
void Dialog_AnalogSynth_1900x1000::set_osc1_signals_connections()
{
...
void Dialog_AnalogSynth_1900x1000::on_osc1_enable_changed(bool en)
{
	ui->checkBox_Osc1Active->blockSignals(true);
	if (en)
	{
...
void Dialog_AnalogSynth_1900x1000::on_osc1_waveform_symmetry_spinbox_changed(int val)
{
	on_osc1_waveform_symmetry_slider_cahanged(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_send_filter_1_spinbox_changed(int val)
{
	on_osc1_send_filter_1_dial_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_send_filter_2_spinbox_changed(int val)
{
	on_osc1_send_filter_2_dial_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_freq_mod_lfo_level_spinbox_changed(int val)
{
	on_osc1_freq_mod_lfo_level_dial_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_freq_mod_adsr_level_spinbox_changed(int val)
{
	on_osc1_freq_mod_adsr_level_dial_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_pwm_mod_lfo_level_spinbox_changed(int val)
{
	on_osc1_pwm_mod_lfo_level_dial_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_pwm_mod_adsr_level_spinbox_changed(int val)
{
	on_osc1_pwm_mod_adsr_level_dial_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_amp_mod_lfo_level_spinbox_changed(int val)
{
	on_osc1_amp_mod_lfo_level_dial_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_amp_mod_adsr_level_spinbox_changed(int val)
{
	on_osc1_amp_mod_adsr_level_dial_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_1_spinbox_changed(int val)
{
	on_osc1_unison_level_1_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_2_spinbox_changed(int val)
{
	on_osc1_unison_level_2_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_3_spinbox_changed(int val)
{
	on_osc1_unison_level_3_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_4_spinbox_changed(int val)
{
	on_osc1_unison_level_4_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_5_spinbox_changed(int val)
{
	on_osc1_unison_level_5_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_6_spinbox_changed(int val)
{
	on_osc1_unison_level_6_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_7_spinbox_changed(int val)
{
	on_osc1_unison_level_7_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_8_spinbox_changed(int val)
{
	on_osc1_unison_level_8_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_9_spinbox_changed(int val)
{
	on_osc1_unison_level_9_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_distortion_spinbox_changed(int val)
{
	on_osc1_unison_distortion_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_unison_detune_spinbox_changed(int val)
{
	on_osc1_unison_detune_slider_changed(val);
}

void Dialog_AnalogSynth_1900x1000::on_osc1_waveform_symmetry_slider_cahanged(int val)
{
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_sqare_enable_changed(bool en)
{
	ui->checkBox_Osc1UnisonSquareWave->blockSignals(true);
	if (en)
	{
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_1_slider_changed(int val)
{
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_2_slider_changed(int val)
{
	if ((val < _OSC1_UNISON_LEVEL_MIN) || (val > _OSC1_UNISON_LEVEL_MAX))
	{
		return;
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_3_slider_changed(int val)
{
	if ((val < _OSC1_UNISON_LEVEL_MIN) || (val > _OSC1_UNISON_LEVEL_MAX))
	{
		return;
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_4_slider_changed(int val)
{
	if ((val < _OSC1_UNISON_LEVEL_MIN) || (val > _OSC1_UNISON_LEVEL_MAX))
	{
		return;
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_5_slider_changed(int val)
{
	if ((val < _OSC1_UNISON_LEVEL_MIN) || (val > _OSC1_UNISON_LEVEL_MAX))
	{
		return;
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_6_slider_changed(int val)
{
	if ((val < _OSC1_UNISON_LEVEL_MIN) || (val > _OSC1_UNISON_LEVEL_MAX))
	{
		return;
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_7_slider_changed(int val)
{
	if ((val < _OSC1_UNISON_LEVEL_MIN) || (val > _OSC1_UNISON_LEVEL_MAX))
	{
		return;
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_8_slider_changed(int val)
{
	if ((val < _OSC1_UNISON_LEVEL_MIN) || (val > _OSC1_UNISON_LEVEL_MAX))
	{
		return;
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_level_9_slider_changed(int val)
{
	if ((val < _OSC1_UNISON_LEVEL_MIN) || (val > _OSC1_UNISON_LEVEL_MAX))
	{
		return;
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_distortion_slider_changed(int val)
{
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_detune_slider_changed(int val)
{
...
void Dialog_AnalogSynth_1900x1000::on_osc1_send_filter_1_dial_changed(int val)
{
	ui->dial_Osc1SendFilter1->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_send_filter_2_dial_changed(int val)
{
	ui->dial_Osc1SendFilter2->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_freq_mod_lfo_level_dial_changed(int val)
{
...
void Dialog_AnalogSynth_1900x1000::on_osc1_freq_mod_adsr_level_dial_changed(int val)
{
	ui->dial_Osc1FreqModAdsrLevel->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_pwm_mod_lfo_level_dial_changed(int val)
{
	ui->dial_Osc1PwmModLFOLevel->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_pwm_mod_adsr_level_dial_changed(int val)
{
	ui->dial_Osc1PwmModAdsrLevel->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_amp_mod_lfo_level_dial_changed(int val)
{
	ui->dial_Osc1AmpModLFOLevel->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_amp_mod_adsr_level_dial_changed(int val)
{
	ui->dial_Osc1AmpModAdsrLevel->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_waveform_combobox_changed(int val)
{
	ui->comboBox_Osc1Waveform->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_tune_octave_combobox_changed(int val)
{
	ui->comboBox_Osc1TuneOctave->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_tune_semitones_combobox_changed(int val)
{
	ui->comboBox_Osc1TuneSemitones->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_tune_cents_combobox_changed(int val)
{
	ui->comboBox_Osc1TuneCents->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_freq_mod_lfo_combobox_changed(int val)
{
	ui->comboBox_Osc1FreqModLFO->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_freq_mod_adsr_combobox_changed(int val)
{
	ui->comboBox_Osc1FreqModAdsr->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_pwm_mod_lfo_combobox_changed(int val)
{
	ui->comboBox_Osc1PwmModLFO->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_pwm_mod_adsr_combobox_changed(int val)
{
	ui->comboBox_Osc1PwmModAdsr->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_amp_mod_lfo_combobox_changed(int val)
{
	ui->comboBox_Osc1AmpModLFO->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_amp_mod_adsr_combobox_changed(int val)
{
	ui->comboBox_Osc1AmpModAdsr->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_hammond_percussion_mode_combobox_changed(int val)
{
	ui->comboBox_Osc1HammondPercussionMode->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_osc1_unison_mode_combobox_changed(int val)
{
	ui->comboBox_Osc1UnisonMode->blockSignals(true);
