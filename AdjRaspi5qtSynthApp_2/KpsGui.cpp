/**
 * @file		KarplusStrongStringsSynthesizerGui.cpp
 *	@author		Nahum Budin
 *	@date		21-Dec-2025
 *	@version	2.0
 *
 *	@brief		Analog Synthesizer instrument Karplus Strong String Synthesizer GUI handling
 *
 *	History:
...
int Dialog_AnalogSynth_1900x1000::init_karplus_strong_gui()
{
	int result;
	...
	// Karplus-Strong Strings frame and controls
	result = init_frame_colors(ui->frame_KarplusStringAll);
...
void Dialog_AnalogSynth_1900x1000::set_kps_signals_connections()
{
...
void Dialog_AnalogSynth_1900x1000::kps_update()
{
	ui->comboBox_KarplusSynth_ExcitationWaveform->blockSignals(true);
	...
	if (kps_enabled)
	{
		ui->frame_KarplusStringAll->setEnabled(true);
	}
	else
	{
		ui->frame_KarplusStringAll->setEnabled(false);
	}
}

void Dialog_AnalogSynth_1900x1000::on_karplus_excitation_waveform_combobox_changed(int val)
{
	ui->comboBox_KarplusSynth_ExcitationWaveform->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_karplus_excitation_waveform_variations_slider_changed(int val)
{
...
void Dialog_AnalogSynth_1900x1000::on_karplus_string_damping_slider_changed(int val)
{
	ui->horizontalSlider_KarplusSynth_StringDamping->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_karplus_string_damping_variation_slider_changed(int val)
{
	ui->horizontalSlider_KarplusSynth_StringDampingVariations->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_karplus_string_damping_calc_mode_combobox_hanged(int val)
{
	ui->comboBox_KarplusSynth_CalculationMode->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_karplus_pluck_damping_slider_changed(int val)
{
	ui->horizontalSlider_KarplusSynth_PluckDamping->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_karplus_pluck_damping_variation_slider_changed(int val)
{
	ui->horizontalSlider_KarplusSynth_PluckDampingVariations->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_karplus_on_decay_slider_changed(int val)
{
	ui->horizontalSlider_KarplusSynth_OnDecay->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_karplus_off_decay_slider_changed(int val)
{
	ui->horizontalSlider_KarplusSynth_OffDecay->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_karplus_send_filter1_dial_changed(int val)
{
	ui->dial_KarplusSynth_SendFilter1->blockSignals(true);
...
void Dialog_AnalogSynth_1900x1000::on_karplus_send_filter2_dial_changed(int val)
{
	ui->dial_KarplusSynth_SendFilter2->blockSignals(true);
